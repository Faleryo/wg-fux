...
// Monotonic counter avoids ID collisions when two toasts fire within the same
// millisecond (Date.now() collisions break React key identity → re-use of DOM
// nodes → wrong toast content/dismissal).
let toastSeq = 0;
