  ...
  const handleSubmit = async (e) => {
    ...
    if (name.trim() && activeContainer) {
      ...
      try {
        ...
        // onCreate ouvre la modale de configuration (QR + config + téléchargement
        // + lien d'import) : on referme celle-ci pour la laisser apparaître.
        onClose();
      } catch (error) {
                ...
                <div className="flex gap-4 animate-in slide-in-from-top-2 duration-300">
                  <div className="relative flex-1">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setExpiryDuration({ ...expiryDuration, value: e.target.value })
                      }
