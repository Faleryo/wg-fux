    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
            ...
            <div className="relative z-10">
              <div className="flex justify-between items-start mb-3">
                ...
                <div className={cn(
                  ...
                  node.status === 'up' ? "bg-emerald-500 shadow-[0_0_8px_#10b981]" : "bg-slate-500"
                )} />
              </div>
              ...
              <div className="space-y-1">
                ...
                <div className="w-full h-1 bg-slate-800 rounded-full overflow-hidden">
                  <motion.div 
                    ...
                    className={cn(
                      "h-full rounded-full",
                      node.load > 80 ? "bg-rose-500" : node.load > 50 ? "bg-amber-500" : "bg-indigo-500"
                    )}
                  />
                </div>
        ...
        <div className="p-4 rounded-2xl border border-dashed border-slate-800 flex flex-col items-center justify-center opacity-40 hover:opacity-100 transition-opacity cursor-pointer group">
           <div className="w-6 h-6 rounded-full border border-slate-600 flex items-center justify-center text-slate-600 group-hover:border-indigo-500 group-hover:text-indigo-500 mb-2">+</div>
           <span className="text-[9px] font-black uppercase text-slate-600 tracking-widest">Connect Edge</span>
        </div>
      </div>
    </div>
  );
