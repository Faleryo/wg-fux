        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6">
          ...
          >
            ...
            <div className="flex items-center justify-between mb-8">
              {title && (
                <h3 className={cn("text-2xl font-black tracking-tight uppercase", isDark ? "text-white" : "text-slate-900")}>{title}</h3>
              )}
              <button
                onClick={onClose}
                className={cn(
                  "p-3 rounded-2xl transition-all",
                  isDark ? "bg-white/5 text-slate-500 hover:text-white hover:bg-white/10" : "bg-slate-100 text-slate-400 hover:text-slate-700 hover:bg-slate-200"
                )}
              >
                <X size={24} />
              </button>
