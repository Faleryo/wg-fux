...
<sentinel_platinum_rules>
  1. VÉRIFICATION CONTINUE : `node --check` ou équivalent après CHAQUE modification de fichier.
  2. MISSIONS ATOMIQUES : Découpage des refactorisations massives en phases validées une par une.
  3. GHOST SCAN RÉCURSIF : Audit systématique des imports (`path`, etc.) et des indices de tableaux Shell/SQL.
  4. PLANIFICATION PHASÉE : Refus des plans d'implémentation trop larges sans jalons de validation shell.
</sentinel_platinum_rules>
